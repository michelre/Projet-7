class Game {
    constructor(level){
        switch(level){
            case 1: this.length = 8; this.nbWall = 3; break;
            case 2: this.length = 16; this.nbWall = 6; break;
            case 3: this.length = 32; this.nbWall = 12; break;
            default: this.length = 16; this.nbWall = 6;
    ...
    start() { 
        ...
        console.log("matrice =" + this.board);
        this.round()
    }
    changePlayer(){
    ...
    validatePosition(cpAvailablePosition,screenX,screenY){
        ...
        console.log("[" + x + "," + y + "]")
        console.log(cpAvailablePosition);
        ...
        console.log("id=" +this.currentPlayer.id);
        console.log("image=" + this.currentPlayer.image);
    ...
    isPlayer(x,y){
        ...
        if(parseInt(this.board[x][y])!= parseInt(this.currentPlayer.id)){
            switch(this.board[x][y]){
                case 1:
                case 2: playerDetected = true; break;
                default: playerDetected = false; break;
            }
        }
    ...
    isWeapon(x,y){
        ...
        switch(this.board[x][y]){
            case 4: weaponDetected = true;
            case 5: weaponDetected = true; 
            case 6: weaponDetected = true; 
            case 7: weaponDetected = true; break;
            default: weaponDetected = false; break;
        }
